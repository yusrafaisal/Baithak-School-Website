...
export default function EditStoryPage() {
    ...
    const invalidStoryId = Number.isNaN(storyId);
    ...
    const [loading, setLoading] = useState(!invalidStoryId);
    const [loadError, setLoadError] = useState<string | null>(invalidStoryId ? "Invalid story id." : null);
