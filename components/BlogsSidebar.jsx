...
function BlogCardSkeleton() {
  return (
    <div className="bc bc--skeleton">
      <div className="bc__img-wrap bc__skel-block" />
      <div className="bc__body">
        <div className="bc__skel-line bc__skel-line--title" />
        <div className="bc__skel-line bc__skel-line--meta" />
        <div className="bc__skel-line bc__skel-line--excerpt" />
        <div className="bc__skel-line bc__skel-line--excerpt" />
        <div className="bc__skel-block bc__skel-btn" />
      </div>
    </div>
  );
}
  ...
  useEffect(() => {
    async function fetchNews() {
      try {
        ...
        let url = "/api/news-stories?limit=6";
        if (category) {
  ...
  return (
    <section className="bs">
        ...
        <div className="bs__grid-wrap">
          ...
          <div className="bs__grid">
            {loading ? (
              ...
              <p className="bs__empty bs__error">{error}</p>
            ) : filtered.length > 0 ? (
              filtered.map((post) => <BlogCard key={post.id} post={post} />)
            ) : (
              <p className="bs__empty">No posts found.</p>
      ...
      <style>{`
        ...
        .bc--skeleton .bc__body { padding-top: 10px; }
        .bc__skel-block {
          background: #e5e7eb;
          border-radius: 6px;
        ...
        .bc__skel-line--title { height: 18px; width: 85%; }
        .bc__skel-line--meta { height: 10px; width: 40%; }
        .bc__skel-line--excerpt { height: 12px; width: 100%; }
        .bc__skel-btn { height: 38px; width: 100%; margin-top: auto; border-radius: 4px; }
